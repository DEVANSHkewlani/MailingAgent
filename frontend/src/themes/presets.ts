 ...
 * All 6 Hermes themes ported directly — Nous, Midnight, Ember, Mono, Cyberpunk, Slate.
 */

import type { DesktopTheme, DesktopThemeTypography } from './types'

const SYSTEM_SANS = '"Inter", -apple-system, BlinkMacSystemFont, "SF Pro Text", system-ui, sans-serif'
const SYSTEM_MONO = '"JetBrains Mono", "SF Mono", ui-monospace, Menlo, Consolas, monospace'
